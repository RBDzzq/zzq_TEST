...
//20220707 changed by zhou end
        ...
        str += '</style>'+
		'</head>'+
		'<body header="nlheader" header-height="20%" footer="nlfooter" footer-height="9%" padding="0.5in 0.55in 0.5in 0.45in" size="A4">'+
		'<table padding-top="194px" border="0" cellpadding="1" cellspacing="1" style="width:660px;"><tr>'+
		//'<table border="0" cellpadding="1" cellspacing="1" style="width:660px;"><tr>'+
...
//    '<tr padding-top="17px">'+
    ...
    str += '</style>'+
    '</head>'+
    '<body header="nlheader" header-height="6%" footer="emptyHeader" footer-height="6%" padding="0.5in 0.55in 0.5in 0.45in" size="A4">'
//    '<table padding-top="-40px" cellspacing="0" cellpadding="5" style="width: 660px;">'+
//    '<tr padding-top="17px">'+
//    '<td>月次請求書番号:</td>'+
//    '<td colspan="2">'+id+'</td>'+
