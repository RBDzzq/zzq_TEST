...
//		'<tr padding-top="10px"><td colspan="4" class="bottom-line-2px" align="center"><span style="margin-left: 120px; font-size: 18px">' + custom.com_legalname + ' 請求明細書</span></td><td class="bottom-line-2px" style="width: 120px" align="right">' + formatDate(new Date()) + '&nbsp;&nbsp;#&nbsp;&nbsp; <pagenumber/></td></tr>'+
		'<tr padding-top="10px"><td colspan="4" class="bottom-line-2px" align="center"><span style="margin-left: 120px; font-size: 18px">' + custom.com_legalname + ' 請求明細書</span></td><td class="bottom-line-2px" style="width: 120px" align="right">' + formatDate(new Date()) + '&nbsp;明細#${dtCnt}</td></tr>'+
		'<tr>'+
		'<td>請求先:</td>'+
...
//			str +='<td align="right" >-${'+Math.abs(inv[i].inComeTaxIn)+'?string[",##0;; roundingMode=halfUp"]}</td>';
	...
	//str += '<pbr/>'
	str += '<#assign dtCnts = 1>'
	str += '<@nlheaderDetail dtCnt = dtCnts />';
	str += '<#assign dtCnts = dtCnts + 1>'
	str += '<table padding-top="-20px" cellspacing="0" cellpadding="5" style="width: 660px;">'+
	'<tr padding-top="17px">'+
	'<td>月次請求書番号:</td>'+
	'<td colspan="2">'+id+'</td>'+
	'<td>&nbsp;</td><td>&nbsp;</td>'+
