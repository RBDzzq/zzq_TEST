...
//	nlapiLogExecution('DEBUG', 'パラメータ', str)
...
//		nlapiLogExecution('DEBUG', 'show me the strArr', strArr);
		...
		if(!isEmpty(locationSearch)){
			...
			if(!isEmpty(mailArr[0])){
				...
				nlapiSendEmail(strArr[1], mailArr[0], '入荷予定送信', '',null,null,null,nlapiLoadFile(pdf_fileid));
				nlapiSendEmail(strArr[1], mailArr[0], '入荷予定送信', '',null,null,null,nlapiLoadFile(csv_fileid));
