...
define(['N/record', 'N/ui/serverWidget', 'N/runtime', 'N/search'], function(record, serverWidget, runtime, search) {
	...
	var FIELD_MAPPING = {};
    var TRANS_LIST = [];
    TRANS_LIST.push('custrecord_djkk_body_flg');//  DJ_承認処理フラグ
    TRANS_LIST.push('custrecord_djkk_body_next_user');// DJ_次の承認者
    TRANS_LIST.push('custrecord_djkk_body_next_role');// DJ_次の承認ロール
    TRANS_LIST.push('custrecord_djkk_body_createrole');// DJ_作成ロール
    TRANS_LIST.push('custrecord_djkk_body_createuser');// DJ_作成者
    TRANS_LIST.push('custrecord_djkk_body_status');// DJ_承認ステータス
    TRANS_LIST.push('custrecord_djkk_body_firstrole');// DJ_第一承認ロール
    TRANS_LIST.push('custrecord_djkk_body_firstuser');// DJ_第一承認者
    TRANS_LIST.push('custrecord_djkk_body_secondrole');// DJ_第二承認ロール
    TRANS_LIST.push('custrecord_djkk_body_seconduser');// DJ_第二承認者
    TRANS_LIST.push('custrecord_djkk_body_thirdrole');// DJ_第三承認ロール
    TRANS_LIST.push('custrecord_djkk_body_thirduser');//DJ_第三承認者
    TRANS_LIST.push('custrecord_djkk_body_fourrole');//DJ_第四承認ロール
    TRANS_LIST.push('custrecord_djkk_body_fouruser');// DJ_第四承認者
    TRANS_LIST.push('custrecord_djkk_body_oper_role');// DJ_承認操作ロール
    TRANS_LIST.push('custrecord_djkk_body_oper_user');// DJ_承認操作者
    TRANS_LIST.push('custrecord_djkk_body_next_condi');//DJ_次の承認条件
    TRANS_LIST.push('custrecord_djkk_body_next_user');// DJ_次の承認者
    TRANS_LIST.push('custrecord_djkk_body_memo');// DJ_承認差戻メモ
    //DJ_預かり在庫実地棚卸承認画面
    FIELD_MAPPING['14'] = TRANS_LIST;
    ...
    function beforeLoad(scriptContext) {
        ...
        var subsidiary = newRec.getValue('custrecord_djkk_body_sub');
    ...
    function dealFieldAndSubList(recType, recId, form, modifyObjs, approvalObj, resetFlg) {
        ...
        if (resetFlg) {
            if (approvalObj == '10') {
                ...
                headList.push('custrecord_djkk_brybery_kyaltuka_memo');
            }
        }
...
//        }
    ...
    function getApprovalObj(recType) {
        ...
        if (recType == 'estimate') {
        	...
        	result = '12';
        }else if(recType == 'customrecord_djkk_body_shedunloading'){
        	result = '13';
