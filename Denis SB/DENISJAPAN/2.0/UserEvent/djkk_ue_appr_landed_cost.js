...
define(['N/record', 'N/ui/serverWidget', 'N/runtime', 'N/search'], function(record, serverWidget, runtime, search) {
	 	...
	 	var FIELD_MAPPING = {};
	    var TRANS_LIST = [];
	    TRANS_LIST.push('custrecord_djkk_landedcost_flg');//  DJ_承認処理フラグ
	    TRANS_LIST.push('custrecord_djkk_landedcost_next_user');// DJ_次の承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_next_role');// DJ_次の承認ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_createrole');// DJ_作成ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_createuser');// DJ_作成者
	    TRANS_LIST.push('custrecord_djkk_landedcost_status');// DJ_承認ステータス
	    TRANS_LIST.push('custrecord_djkk_landedcost_firstrole');// DJ_第一承認ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_firstuser');// DJ_第一承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_secondrole');// DJ_第二承認ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_seconduser');// DJ_第二承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_thirdrole');// DJ_第三承認ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_thirduser');//DJ_第三承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_fourrole');//DJ_第四承認ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_fouruser');// DJ_第四承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_oper_role');// DJ_承認操作ロール
	    TRANS_LIST.push('custrecord_djkk_landedcost_oper_user');// DJ_承認操作者
	    TRANS_LIST.push('custrecord_djkk_landedcost_next_condi');//DJ_次の承認条件
	    TRANS_LIST.push('custrecord_djkk_landedcost_next_user');// DJ_次の承認者
	    TRANS_LIST.push('custrecord_djkk_landedcost_memo');// DJ_承認差戻メモ
	    //changed by song add 0531 start
	    TRANS_LIST.push('custrecord_djkk_landedcost_cancel_memo');// DJ_承認却下メモ
