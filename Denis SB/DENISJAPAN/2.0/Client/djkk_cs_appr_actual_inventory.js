...
define([], function() {
  ...
  if (mode == 'edit') {
    	var apprFlag = curRec.getValue('custrecord_djkk_shedunloading_flg');
   if(apprFlag){
    if(curRec.getValue('custrecord_djkk_shedunloading_status')&&curRec.getValue('custrecord_djkk_shedunloading_status')!='4'){
    ...
    function fieldChanged(scriptContext) {
        ...
        if (scriptContext.fieldId == 'custpage_djkk_trans_appr_user') {
            ...
            if (dealType != '10') {
                curRec.setValue({
                    fieldId : 'custrecord_djkk_shedunloading_next_user',
