...
//    	var oldRecord = scriptContext.oldRecord
        ...
        var subsidiary =  newRecord.getValue('custrecord_djkk_admit_subsidiary');
        var createrole =  newRecord.getValue('custrecord_djkk_admit_create_role');
        ...
        var approvalObj = script.getParameter({
            name : 'custscript_djkk_ic_wf_obj'
        });

        // 処理区分
        var dealKbn = script.getParameter({
            name : 'custscript_djkk_ic_kbn'
        });
