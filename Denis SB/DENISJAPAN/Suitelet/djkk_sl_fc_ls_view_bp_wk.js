 ...
 * @returns 結果HTML
 */
function doSearch(pUser, date, pBrand, pProductCodes,pBrandNms, pProductNms, pSW, pSH,subsidiary) {
...
//					   ["custcol_djkk_custody_item","is","F"]
					   "AND",
					   ["salesrep.internalid","anyof",userArray[i]]
					], 
					[
			...
			if (!isEmpty(salesorderSearch)) {
				for (var aIs = 0; aIs < itemArr.ids.length; aIs++) {
					...
					soOutSearchArray.push([itemArr.ids[aIs], soItemArray, userArray[i]]);
				}
			}else{
				for (var aIs = 0; aIs < itemArr.ids.length; aIs++) {
					var soItemArray = new Array();
		...
		/*******************fc前回******************/
		  ...
		  var fclsSearch = nlapiSearchRecord("customrecord_djkk_so_forecast_ls",null,
				  [
				     ...
				     "AND", 
				     ["custrecord_djkk_so_fc_ls_item","anyof",itemArr.ids], 
				     "AND", 
				     ["custrecord_djkk_so_fc_ls_employee","anyof",userArray[i]]
				  ], 
				  [
		  ...
		  if (!isEmpty(fclsSearch)) {
				for (var aIa = 0; aIa < itemArr.ids.length; aIa++) {
					...
					fcSearchArray.push([itemArr.ids[aIa], fcDataArray,userArray[i]]);
		...
		/*************************************/
		  ...
		  var otherFclsSearch = nlapiSearchRecord("customrecord_djkk_so_forecast_ls",null,
				  [
				     ...
				     ["custrecord_djkk_so_fc_ls_item","anyof",itemArr.ids], 
				     "AND", 
				     ["custrecord_djkk_so_fc_ls_employee","noneof",userArray[i]]
				  ], 
				  [
		  ...
		  if (!isEmpty(otherFclsSearch)) {
				for (var oaIa = 0; oaIa < itemArr.ids.length; oaIa++) {
					...
					otherFcSearchArray.push([itemArr.ids[oaIa], otherFcDataArray,userArray[i]]);
				}			
		  }else{
				for (var oaIa = 0; oaIa < itemArr.ids.length; oaIa++) {
					  var otherFcDataArray = new Array();
						...
						otherFcSearchArray.push([itemArr.ids[aIa], otherFcDataArray,userArray[i]]);
		  		}	  
		  	}
