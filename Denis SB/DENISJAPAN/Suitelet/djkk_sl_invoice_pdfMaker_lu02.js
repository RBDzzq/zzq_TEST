...
try{
    var type = nlapiGetContext().getSetting('SCRIPT', 'custscript_scriptcustscript02'); //type 請求書 orクレジットメモ
    if(type == 'invoice'){
        //請求書
        var invAmount = 0;
        var invTaxamount = 0;
        var itemLine = new Array();
        var invoiceID = nlapiGetContext().getSetting('SCRIPT', 'custscript_scriptcustscript01'); //ID
...
//  '<td>〒'+invoiceZipcode+'</td>'+
    ...
    if (invoiceCity) {
        invoiceAddressDates.push(invoiceCity)
    }
    if (custNameText) {
    ...
    //  '<td colspan="2" style="margin-top:-8px;">&nbsp;&nbsp;&nbsp;&nbsp;'+address3+'</td>'+
        ...
        '<td align="left" style="padding-bottom:0px;margin-top:-8px;">'+yuZhong+'</td>'+
        '</tr>'
    }
    //CH734 20230719 by zzq end
    str+='<tr>'+
...
//      '</tr>';
    ...
    '<td colspan="2">&nbsp;</td>'+
    '<td style=";margin-top:-16px;" rowspan="5"><div><img src="'+SECURE_URL_HEAD+'/core/media/media.nl?id=480236&amp;'+URL_PARAMETERS_C+'&amp;h=I4MoOlKGNT5wClfzyGHDmnp273JBVQ9BPk9YazigRcR_dkkh" style="width:100px;height: 100px; position:absolute;top:42px;left:-115px;" /></div></td>'+
...
//        str+='<tr><td style="margin-top:-8px;margin-left:26px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + address1 + '</td>' +
        str+='<tr><td style="margin-top:-8px;margin-left:26px"></td>' +
            ...
            '<td style="width:220px;margin-top:-8px;" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+dealFugou(invdestinationAddress3)+'</td></tr>';
    }else{
...
//          str+='<tr padding-top="1px"><td colspan="3" style="margin-top:3px"></td></tr>';
    //  }
        ...
        if(bankName2){
            ...
            '<td style="margin-top:-8px;margin-left:7px;width:35%">'+bankBranchName2+'</td>'+
...
//              '<td style="margin-top:-8px;margin-left:7px;width:30%">'+bankNo2+'</td>'+
    ...
    str+='<body header="nlheader" header-height="26%" padding="0.2in 0.5in 0.5in 0.5in" size="A4" footer="nlfooter" footer-height="10%">'+
    //'<table style="width: 660px;font-weight: bold;" padding-top="10px">'; 
    '<table style="width: 660px;font-weight: bold;" padding-top="42px">'; 
