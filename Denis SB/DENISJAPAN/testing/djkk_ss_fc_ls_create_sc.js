...
function scheduled(type) {
	nlapiLogExecution('debug', 'DJ_SC課FC作成 LSssStart');
...
//			var dateweek = getYearWeek(changeDate);
			...
			//20230327 changed by zhou start CH355
//			if (dateweek == '52') {
//				dateweek = '1';
...
//			}
			//20230327 changed by zhou end CH355
...
//					var scFcInLess=scFcRecord.getFieldValue('custrecord_djkk_sc_fc_ls_minus');
	...
	nlapiLogExecution('debug', 'DJ_SC課FC作成ssEND');
}
