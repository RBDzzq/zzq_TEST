...
function clientLineInit(type){
	...
	if (dealType == 'edit' || dealType == 'copy') {
        ...
        // DJ_ブランド
	    if (dtBrand) {
	        nlapiSetCurrentLineItemValue('recmachcustrecord_djkk_pldt_pl_fd', 'custrecord_djkk_pldt_brand', dtBrand, true, false);
	    }
        // DJ_商品コード
        if (dtItemCode) {
            nlapiSetCurrentLineItemValue('recmachcustrecord_djkk_pldt_pl_fd', 'custrecord_djkk_pldt_itemcode_fd', dtItemCode, true, false);
        }
        // DJ_仕入先
        if (dtSupplier) {
