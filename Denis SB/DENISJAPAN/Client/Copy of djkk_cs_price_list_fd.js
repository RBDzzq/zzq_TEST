...
function clientLineInit(type){
	...
	} else  if (dealType == 'edit' || dealType == 'copy') {
	    var con=nlapiGetLineItemCount('recmachcustrecord_djkk_pldt_pl_fd');
	    if (con > 0) {
	        if (dealFlg) {
//	            var brand = nlapiGetCurrentLineItemValue('recmachcustrecord_djkk_pldt_pl_fd', 'custrecord_djkk_pldt_brand');
	            nlapiSetCurrentLineItemValue('recmachcustrecord_djkk_pldt_pl_fd', 'custrecord_djkk_price_subsidiary_pl_fd', sub, false, true);
//	            if (brand) {
//	                nlapiSetCurrentLineItemValue('recmachcustrecord_djkk_pldt_pl_fd', 'custrecord_djkk_pldt_brand', brand, true, false);
//	            }   
	            dealFlg = false;
	        }
	    } else {
