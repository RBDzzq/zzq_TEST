...
function clientFieldChanged(type, name, linenum){
	if(name == 'custpage_sub' || name == 'custpage_inventory_report_location'){
		...
		var https = nlapiResolveURL('SUITELET', 'customscript_djkk_sl_inv_report_history', 'customdeploy_djkk_sl_inv_report_history');
...
function search(){
	...
	var date = nlapiGetFieldValue('custpage_inventory_report_date')
...
function setParam(){
	var parameter = '';
	var filedSubValue =  nlapiGetFieldValue('custpage_sub');//20230723 add by zhou
	...
	if( filedSubValue == SUB_SCETI ||  filedSubValue == SUB_DPKK){//20230723 add by zhou
