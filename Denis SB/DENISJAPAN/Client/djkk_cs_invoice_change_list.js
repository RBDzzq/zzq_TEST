...
function clientFieldChanged(type, name, linenum) {
	if(name == 'custpage_subsidiary'){
		...
		var https = nlapiResolveURL('SUITELET', 'customscript_djkk_sl_invoice_change_list', 'customdeploy_djkk_sl_invoice_change_list');
...
function setParam(){
	...
	parameter += '&hopeDeliveryDateEnd='+nlapiGetFieldValue('custpage_delivery_hopedate_end');//3.26 add geng todolist U674
	parameter += '&deliveryDate='+nlapiGetFieldValue('custpage_delivery_date');
	parameter += '&deliveryDateEnd='+nlapiGetFieldValue('custpage_delivery_date_end');//3.26 add geng todolist U674
	parameter += '&loadOutDate='+nlapiGetFieldValue('custpage_load_out_date');//3.26 add geng todolist U674
	parameter += '&loadOutDateEnd='+nlapiGetFieldValue('custpage_load_out_date_end');//3.26 add geng todolist U674
	parameter += '&user='+nlapiGetFieldValue('custpage_user');
